                    ...
                    for ($td=1; $td<=10; $td++){
                        ...
                        switch ($rez[0]) {
                            case (1):
                                switch ($rez[1]) {
                                    case (1):
                                        $rez= $red.$rez[0].$sp.$red.$rez[1].$sp.$rez[2];
                                        break;
                                    case (2):
                                        $rez= $red.$rez[0].$sp.$green.$rez[1].$sp.$rez[2];
                                        break;
                                    case (3):
                                        $rez=$red.$rez[0].$sp.$yellow. $rez[1].$sp.$rez[2];
                                        break;
                                    case (4):
                                        $rez=$red.$rez[0].$sp.$blue. $rez[1].$sp.$rez[2];
                                        break;
                                    default:
                                        $rez=$red. $rez[0].$sp.$rez[1].$rez[2];
                                }
                                break;
                            case (2):
                                switch ($rez[1]) {
                                    case (1):
                                        $rez= $green.$rez[0].$sp.$red.$rez[1].$sp.$rez[2];
                                        break;
                                    case (2):
                                        $rez= $green.$rez[0].$sp.$green.$rez[1].$sp.$rez[2];
                                        break;
                                    case (3):
                                        $rez=$green.$rez[0].$sp.$yellow. $rez[1].$sp.$rez[2];
                                        break;
                                    case (4):
                                        $rez=$green.$rez[0].$sp.$blue. $rez[1].$sp.$rez[2];
                                        break;
                                    default:
                                        $rez=$green. $rez[0].$sp.$rez[1].$rez[2];
                                }
                                break;
                            case (3):
                                switch ($rez[1]) {
                                    case (1):
                                        $rez= $yellow.$rez[0].$sp.$red.$rez[1].$sp.$rez[2];
                                        break;
                                    case (2):
                                        $rez= $yellow.$rez[0].$sp.$green.$rez[1].$sp.$rez[2];
                                        break;
                                    case (3):
                                        $rez=$yellow.$rez[0].$sp.$yellow. $rez[1].$sp.$rez[2];
                                        break;
                                    case (4):
                                        $rez=$yellow.$rez[0].$sp.$blue. $rez[1].$sp.$rez[2];
                                        break;
                                    default:
                                        $rez=$yellow. $rez[0].$sp.$rez[1].$rez[2];
                                }
                                break;
                            case (4):
                                switch ($rez[1]) {
                                    case (1):
                                        $rez= $blue.$rez[0].$sp.$red.$rez[1].$sp.$rez[2];
                                        break;
                                    case (2):
                                        $rez= $blue.$rez[0].$sp.$green.$rez[1].$sp.$rez[2];
                                        break;
                                    case (3):
                                        $rez=$blue.$rez[0].$sp.$yellow. $rez[1].$sp.$rez[2];
                                        break;
                                    case (4):
                                        $rez=$blue.$rez[0].$sp.$blue. $rez[1].$sp.$rez[2];
                                        break;
                                    default:
                                        $rez=$blue. $rez[0].$sp.$rez[1].$rez[2];
                                }
                                break;
                            default:
                                switch ($rez[1]) {
                                    case (1):
                                        $rez= $rez[0].$sp.$red.$rez[1].$sp.$rez[2];
                                        break;
                                    case (2):
                                        $rez= $rez[0].$sp.$green.$rez[1].$sp.$rez[2];
                                        break;
                                    case (3):
                                        $rez=$rez[0].$sp.$yellow. $rez[1].$sp.$rez[2];
                                        break;
                                    case (4):
                                        $rez=$rez[0].$sp.$blue. $rez[1].$sp.$rez[2];
                                        break;
                                    default:
                                        $rez=$rez[0].$sp.$rez[1].$rez[2];
                                }
                        }
